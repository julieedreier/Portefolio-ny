...
async function getPost(pageValue) {
    ...
    const post = await fetch(`https://hbosp6wm.api.sanity.io/v1/data/query/production?query=*[slug.current == "${pageValue}"]`);
...
async function getPosts() {
    ...
    const posts =  await fetch(`https://hbosp6wm.api.sanity.io/v1/data/query/production?query=*`);
    ['_type' == "post"]
    ...
    const cdnUrl = 'https://cdn.sanity.io/images/hbosp6wm/production/';
